...
export const ScrollStackItem = ({ children, itemClassName = '' }) => (
  <div
    className={`scroll-stack-card relative w-full min-h-[450px] my-8 p-6 md:p-12 rounded-[40px] shadow-[0_0_30px_rgba(0,0,0,0.1)] box-border origin-top will-change-transform ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      if (hasChanged) {
        ...
        // Apply styles directly to the DOM for maximum performance
  ...
  const setupLenis = useCallback(() => {
    const lenisOptions = {
      ...
      prevent: node => !!node?.closest?.('[data-lenis-prevent], [data-lenis-prevent-wheel], [data-lenis-prevent-touch]')
    };
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner pt-[5vh] px-4 md:px-20 pb-[30rem] min-h-screen">
        {children}
