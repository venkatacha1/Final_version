        ...
        <div style={scaleStyle} className={className}>
            ...
            >
                ...
                >
                    ...
                    {/* Open Help Text */}
                    <div className={`absolute -bottom-10 left-1/2 -translate-x-1/2 whitespace-nowrap transition-all duration-500 pointer-events-none ${open ? 'opacity-0 scale-95 -translate-y-2' : 'opacity-100 scale-100 translate-y-0'}`}>
                        <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-500 group-hover:text-theme-primary transition-all duration-300">
