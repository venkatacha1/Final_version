...
const NidhiLimitedCompliance = () => {
    ...
    const documents = [
        ...
        { title: "NDH-1 (Statutory Compliance)", icon: "fa-file-contract" },
        { title: "NDH-3 (Half Yearly Return)", icon: "fa-calendar-days" },
        { title: "List of Members/Shareholders", icon: "fa-users" }
    ];
    ...
    const cards = [
        {
            ...
            desc: "Return of Statutory Compliances to be filed within 90 days from the close of the first financial year after incorporation."
        },
        {
            title: "NDH-3 Return",
            icon: "fa-calendar-days",
            desc: "Half-yearly return to be filed by every Nidhi company within 30 days from the conclusion of each half-year."
        },
        {
            title: "Member Requirements",
            icon: "fa-users",
            desc: "Maintaining a minimum of 200 members within one year of incorporation is a critical ongoing compliance for Nidhi companies."
        },
        {
            title: "Net Owned Funds",
            icon: "fa-vault",
            desc: "Ensuring Net Owned Funds (NOF) reach at least ₹10 lakhs or more to maintain the Nidhi status."
        },
        {
            title: "Unencumbered Deposits",
            icon: "fa-hand-holding-dollar",
            desc: "Maintaining unencumbered term deposits of not less than 10% of the outstanding deposits as per Nidhi Rules."
        },
        {
            title: "Director Compliance",
            icon: "fa-user-tie",
            desc: "Annual DIR-3 KYC for all directors is mandatory, regardless of the company's activity level."
        }
    ];

    const nidhiCompliances = [
        { title: "Form NDH 1", icon: "fa-file-invoice", desc: "This form is used to file Return of Statutory compliance which includes details regarding company's members, loans, deposits, reserves etc. for the complete financial year. It should be filed within 90 days from the closure of the first financial year after incorporation." },
        { title: "Form NDH 2", icon: "fa-calendar-plus", desc: "This form is used for filing application for extension of time: (1) The company fails to add at least 200 members within one year of incorporation. (2) Failure to maintain the Net owned Fund to deposit ratio of 1:20." },
        { title: "Form NDH 3", icon: "fa-file-lines", desc: "This form is used for filing Half yearly return with the Registrar of Companies (ROC). Within 30 days from the end of each half year along with prescribed fees. It must be duly certified by a practicing chartered account, or company secretary or cost accountant." },
        { title: "Form NDH 4", icon: "fa-certificate", desc: "NDH-4 is a declaration and it must be filed within 120 days from the date of incorporation. The approval will be given from the central government within 45 days and the paid up capital should be minimum of 10L." },
    ...
    const faqs = [
        {
            id: 1,
            title: "What is NDH-1?",
            description: "NDH-1 is the return of statutory compliances that a Nidhi company must file within 90 days from the end of its first financial year.",
            icon: <i className="fa-solid fa-circle-question"></i>
        },
        {
            id: 2,
            title: "When is NDH-3 filed?",
            description: "NDH-3 is a half-yearly return filed twice a year, within 30 days of the end of each half-year (September and March).",
            icon: <i className="fa-solid fa-clock"></i>
        },
        {
            id: 3,
            title: "What is the minimum member requirement?",
            description: "A Nidhi company must have at least 200 members within one year of its commencement.",
            icon: <i className="fa-solid fa-user-group"></i>
        },
        {
            id: 4,
            title: "What is the penalty for non-compliance?",
            description: "Non-compliance with Nidhi rules can lead to fines and may even result in the company being prohibited from accepting further deposits.",
            icon: <i className="fa-solid fa-triangle-exclamation"></i>
        },
        {
            id: 5,
            title: "Can a Nidhi company open branches?",
            description: "Yes, but only after 3 years of continuous profitability and with proper intimation/approval from the ROC.",
    ...
    return (
        <div className="relative min-h-screen bg-white text-[#1a2b1f]">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/images/logo/nidhi_hero.png')" }}
            >
                {/* Subtle Overlay */}
                ...
                <div className="container mx-auto px-4 lg:px-10 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 py-12 lg:py-0">
                    ...
                    <div className="max-w-4xl">
                        <h1 className="text-2xl sm:text-3xl lg:text-5xl font-bold mb-4 leading-tight">Nidhi Limited Company Compliance</h1>
                        <p className="text-lg lg:text-xl font-medium mb-4 sm:mb-8">
                            NDH Forms Assistance | Half-Yearly Returns | Regulatory Monitoring
                        </p>
                        ...
                        <h2 className="text-xl lg:text-3xl font-bold leading-relaxed">
                            Ensuring smooth financial operations for your Nidhi business
                        </h2>
                    </div>

                    {/* Right Content - Reusable Form Component */}
                    <ServiceForm title="Nidhi Limited Compliance" />
                </div>
            </div>
            ...
            <section className="py-24 bg-gray-50/50">
                <div className="container mx-auto px-4 lg:px-10">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold mb-4">Specific Nidhi Compliances</h2>
                ...
                <div className="container mx-auto px-4 lg:px-10 relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
                        <div className="max-w-2xl text-left">
                            <h6 className="text-theme-primary uppercase tracking-[0.3em] font-bold text-sm mb-4">Statutory Nidhi Ledger</h6>
                    ...
                    <div className="mt-40 mb-16 relative text-left">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                            <div className="max-w-2xl">
                                <h6 className="text-theme-primary uppercase tracking-[0.3em] font-bold text-sm mb-4">Financial Adherence</h6>
                                <h2 className="text-4xl md:text-6xl font-black text-[#0a0a0a] tracking-tight leading-none">
                                    Functional <br />
                ...
                <div className="container mx-auto px-4 lg:px-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Got questions? We've got answers. Explore our common queries about Nidhi Limited Compliance.
                        </p>
            ...
            <ConsultModal
                ...
                title="Nidhi Limited Compliance Consultation"
            />
        </div>
    );
};

export default NidhiLimitedCompliance;
