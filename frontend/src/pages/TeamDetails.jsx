            ...
            <section className="page-title" style={{ backgroundImage: 'url(/images/background/page-title-bg.jpg)' }}>
                <div className="auto-container">
                    <div className="title-outer">
                        <h1 className="title">Attorney Details</h1>
                            ...
                            <div className="col-xl-6 col-lg-6">
                                <div className="team-details__top-left">
                                    <div className="team-details__top-img">
                                        <img className="w-100" src="/images/resource/team-details.jpg" alt="Alen Hispro" />
                                ...
                                <div className="team-details__top-right pt-50">
                                    <div className="team-details__top-content">
                                        ...
                                        <div className="team-details-contact mb-30">
                                            ...
                                            <div className=""><span><a href="mailto:info@example.com">info@example.com</a></span></div>
                                        </div>
                                        <div className="team-details-contact mb-30">
                        ...
                        <div className="col-lg-8">
                            <form id="contact_form" onSubmit={(e) => e.preventDefault()}>
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        <div className="mb-3">
                                            <input name="form_subject" className="form-control" type="text" placeholder="Enter Subject" />
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                        <div className="mb-3">
                                ...
                                <div className="mb-3 text-center">
                                    <button type="submit" className="btn-two wow fadeInUp me-2">Send message</button>
                                    <button type="reset" className="btn-one wow fadeInUp rounded-0">Reset</button>
                                </div>
                            </form>
                        </div>
                    </div>
